...
public class ProgramacionFuncional {
   ...
   * api en edevelop.
   *
   * @param args inicia api.
   */
  public static void main(String[] args) {

    /*La programación funcional es un estilo de escribir programas donde tratamos las
    operaciones como
     si fueran funciones matemáticas. En lugar de cambiar y manipular datos directamente,
      trabajamos con
     funciones que toman datos de entrada y producen resultados sin cambiar nada fuera de
      sí mismas. Además,
     evitamos efectos secundarios impredecibles y nos centramos en construir programas
    ...
    //----------------------Consumer----------------------
    /* La interfaz Consumer en Java es parte del paquete java.util.function y representa una
        operación que toma un solo
         argumento de entrada y no devuelve ningún resultado. Es decir, toma algo (puede ser
          un objeto, un valor, etc.)
    ...
    // es una operacion que sera tratado como una funcion y estara iniciazado con
    // interfaces funcioneles
